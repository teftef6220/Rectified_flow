...
# 顔検出器
face_detector = dlib.simple_object_detector("./make_dataset/model/detector_face.svm")
# 目検出器
eye_detector = dlib.simple_object_detector("./make_dataset/model/detector_eye.svm")

img_path = './make_dataset/Mafuyu_example_01.png'
...
# 顔部分を赤線で囲った画像の保存
cv2.imwrite('./make_dataset/faces.png',image)
